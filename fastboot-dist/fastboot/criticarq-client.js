...
define('criticarq-client/initializers/fastboot/ajax', ['exports'], function (exports) {
  /* globals najax */
...
define("criticarq-client/initializers/fastboot/dom-helper-patches", ["exports"], function (exports) {
  /*globals Ember, URL*/
  exports["default"] = {
...
define('criticarq-client/instance-initializers/fastboot/head', ['exports'], function (exports) {
  exports.initialize = initialize;

  function initialize(instance) {
    var renderer = instance.lookup('renderer:-dom');
    var componentFactory = instance._lookupFactory('component:head-layout');
    // explicitly set renderer & domhelper since we're in fastboot
    var component = componentFactory.create(instance.ownerInjection(), {
      renderer: renderer,
...
define('criticarq-client/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"criticarq-client","environment":"development","baseURL":"/","locationType":"auto","disqus":{"shortname":"criticarq"},"EmberENV":{"FEATURES":{}},"APP":{"name":"criticarq-client","version":"0.0.0+d4fa0129","autoboot":false},"apiHost":"http://content.criticarq.gt","metricsAdapters":[{"name":"GoogleAnalytics","environments":["development"],"config":{"id":"UA-44116271-3"}}],"something":"test","exportApplicationGlobal":true,"ember-load":{"loadingIndicatorClass":"ember-load-indicator"}}};
});
